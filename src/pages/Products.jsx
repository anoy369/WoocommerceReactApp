...
import { BsCart4, BsSearch, BsFilter } from "react-icons/bs";
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Simulate best sellers (you can replace with real data from API)
        const productsWithFlags = data.map((p) => ({
          ...p,
          // Simulate best sellers (e.g., product ID 139 is best seller)
    ...
    <>
      ...
      <div className="container my-5">
                  ...
                  <div className="card h-100 d-flex">
                    ...
                    <div className="card-body d-flex flex-column align-items-center">
                      ...
                      <div className="d-flex align-items-center justify-content-center mt-auto">
                        ...
                        >
                          { symbol }{product.regular_price || product.price}
                        </span>
                        {product.sale_price && (
                          <span className="fw-bold">{ symbol }{product.sale_price}</span>
                        )}
                      </div>
        ...
        <div className="row mt-4">
          ...
          >
            ...
            <div className="mb-4">
              ...
              <small className="d-block mt-2 text-muted">
                Range: { symbol }{priceRange[0]} — { symbol }{priceRange[1]}
              </small>
            </div>
          ...
          {/* Product Grid */}
          <div className={`col-lg-9 ${showFilters ? "col-12 col-lg-9" : ""}`}>
